/**
 * @file        IndexManager.h
 * @brief       Định nghĩa bộ quản lý chỉ mục tích hợp (Index Manager) cho hệ thống log.
 *
 * Điều phối đồng thời chỉ mục băm đa chiều (HashIndex) và chỉ mục sắp xếp theo thời gian (SortedIndex),
 * cung cấp cơ chế tự động tính toán cấu hình tối ưu dựa trên quy mô dữ liệu.
 */
...
/**
 * @brief Khởi tạo và xây dựng toàn bộ hệ thống chỉ mục từ kho lưu trữ DataStore.
 * @note  Hàm tự động lựa chọn kích thước bảng băm (Table Size) tối ưu là số nguyên tố dựa trên số lượng bản ghi.
 *        Đồng thời in thông tin thời gian khởi tạo ra console theo định dạng: "[INFO] Indexes built in Xs"
...
/**
 * @brief Xóa bỏ dữ liệu và giải phóng toàn bộ bộ nhớ của tất cả các chỉ mục thành phần.
