 ...
 * @brief       Định nghĩa các loại hành vi bất thường và cấu trúc lưu trữ dữ liệu cảnh báo.
 *
 * File này chứa các enum phân loại mức độ, phân loại hành vi vi phạm (AnomalyType),
 * cấu trúc lưu trữ bản ghi (AnomalyRecord) và cấu trúc danh sách mảng động (AnomalyList).
 */
...
/**
 * @brief Thêm một bản ghi bất thường mới vào danh sách (Tự động tăng kích thước mảng nếu đầy).
