 ...
 * @brief       Định nghĩa các cấu hình ngưỡng (threshold) cho hệ thống phát hiện bất thường.
 *
 * Các giá trị hằng số trong namespace này quy định giới hạn an toàn của hệ thống.
 * Mọi hành vi vượt quá các ngưỡng này đều bị coi là dấu hiệu vi phạm an ninh.
 */
...
namespace AnomalyConfig
{
    ...
    const int IMPOSSIBLE_TRAVEL_MINS = 120;   ///< Ngưỡng thời gian tối thiểu giữa 2 lần đăng nhập ở khoảng cách xa (phút)
