...
File CSV test lớn (>1M dòng) không được đính kèm trong bài nộp
do vượt quá giới hạn dung lượng upload (20MB).

Vui lòng tải file dữ liệu (>1M dòng) từ Moodle môn học (Cơ sở lập trình - CQ2025/7)
...
- src/data/halo_dataset_1m.csv (1,000,000 dòng)
